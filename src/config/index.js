...
const Apis = {
  ...
  GetProductServiceWithQohApi: `${API_URL}/api/productService/GetProductServiceWithQoh`,
  ...
  GetLedgerDetails : `${API_URL}/api/Report/GetLedgerDetails`,
  ...
  //create of inventory
  CreateUnitApi: `${API_URL}/api/Unit/CreateUnit`,
  GetUnitApi: `${API_URL}/api/Unit/GetAllUnits`,
};
