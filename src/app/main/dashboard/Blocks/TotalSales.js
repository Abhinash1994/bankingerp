...
import { getTotalSales } from "app/store/actions/dashboard";
    ...
    <div className="total-sales dashboard-block">
      ...
      <div className="dashboard-block__body">
        <div className="body-row">
          <span className="total-sales">{value && value.totalSales}</span>
        </div>
        <div className="body-row">
