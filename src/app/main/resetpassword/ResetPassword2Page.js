                        ...
                        <CardContent className="flex flex-col items-center justify-center p-32 md:p-48 md:pt-128">
                            ...
                            <Typography variant="h6" className="md:w-full mb-32">RESET YOUR PASSWORD</Typography>
                                ...
                                <Button variant="contained" color="primary" className="w-224 mx-auto mt-16" aria-label="Reset"
                                        disabled={!this.canBeSubmitted()} onClick={this.resetPassword}>
                                    RESET MY PASSWORD
                                </Button>
...
function mapDispatchToProps(dispatch)
{
    return bindActionCreators({
        // resetpassword: authActions.login
    }, dispatch);
}
...
export default withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(ForgotPassword2Page)));
