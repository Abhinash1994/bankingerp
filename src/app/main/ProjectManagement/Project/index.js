...
const tableRows = [
  { id: 'project_name', numeric: false, disablePadding: true, label: 'Project Name', width: '' },
  { id: 'branch_vode', numeric: false, disablePadding: false, label: 'Code', width: '150px' },
...
class ProjectPage extends Component {
  ...
  handleRemove = async row => {
    await ProjectService.removeProject(row.id);
    // if (result) {
            ...
            <div className="flex flex-1 flex-col items-center justify-center md:flex-row md:items-center md:justify-start">
              <div className="flex items-center">
                ...
                <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                  <Typography variant="h6" className="hidden sm:flex">Project</Typography>
                </FuseAnimate>
              </div>
            </div>
          </div>
