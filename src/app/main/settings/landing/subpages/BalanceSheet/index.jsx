...
class TrialBalance extends Component {
  ...
  getBalanceData = async () => {
    ...
    const netEarning = Number(balanceData['Assets'].debit-balanceData['Assets'].credit) - Number(balanceData['Liabities'].credit-balanceData['Liabities'].debit);
    balanceData['Net earning'] = {
      title: 'Net Earining', debit: 0, credit: netEarning, isBold: true, type: 200
    };
    balanceData['Total'] = {
      title: 'Total', debit: 0, credit: Number(balanceData['Liabities'].credit) + netEarning, isBold: true, type: 200
    };
    console.log(balanceData);
    this.setState({
  ...
  ExportPdf = () => {
    ...
    PrintService.printBalanceReport('Balance sheet', balanceData);
  }
              ...
              <div className="flex flex-1 items-center">
                <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                  <div className="flex flex-1 hidden sm:flex">
                    <Typography variant="h6" className="hidden sm:flex">{'Balance sheet'}</Typography>
