...
class AccountReciveablePage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      order: "asc",
  ...
  async viewData() {
    ...
    let dataList = await ChartOfAccountService.getAccountRecieveReport(filter);
  ...
  ExportPDF() {
    ...
    if (this.state.rows.length > 0) {
      ...
      PrintService.printAccountpayable(this.state.rows, false, "Account Receivable");
    }
  }
  ...
  PrintData() {
    ...
    if (this.state.rows.length > 0) {
      ...
      row.total = 'Rs.'+sum;
      this.state.rows.push(row);
      PrintService.printAccountpayable(this.state.rows, true, "Account Receivable");
    }
  }
              ...
              <Table className={classes.table}>
                ...
                <TableBody>
                  ...
                  <TableRow>
                    ...
                    <TableCell align="left" colSpan={2}><span>Rs.{_.sum(_.map(this.state.rows, d => d.balance))}</span></TableCell>
                  </TableRow>
                  <TableRow>
...
export default withStyles(styles, { withTheme: true })(
  connect(mapStateToProps, mapDispatchToProps)(AccountReciveablePage)
);
