...
import { withStyles, Icon, Input, Tooltip,} from '@material-ui/core';
...
const rows = [
    { id: 'SN', numeric: false, disablePadding: true, label: 'SN' },
    { id: 'date', numeric: false, disablePadding: false, label: 'Date' },
    { id: 'transaction', numeric: false, disablePadding: false, label: 'Tran No' },
    { id: 'dramt', numeric: true, disablePadding: false, label: 'Debit' },
        ...
        return (
            <div>
                <div className="p-24 flex flex-1 flex-col items-center justify-center md:flex-row md:items-center">
                    ...
                    <SupportDialog type='add' onSave={this.handleSave} onRemove={this.handleRemove} row={{SN: '', date: '', transaction: '', dramt: '',details: '', remarks: '',}}/>
                </div>
