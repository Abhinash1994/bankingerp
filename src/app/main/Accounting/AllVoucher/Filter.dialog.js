...
import LabelControl from "app/components/LabelControl";
class FilterDialog extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      events: ["JV", "PV", "CV", "RV", "SI", "PI", "BDBWR"],
    };
  ...
  changeDate = (event) => {
    ...
    this.setState({
      ...
      filter: { ...this.state.filter, from, to },
    });
  };
  ...
  render() {
    ...
    return (
      <Dialog
        className="all-voucher-filter-dialog"
        fullWidth
      ...
      >
        <DialogContent className="dialog">
          ...
          <div className="list-date flex justify-between items-center">
          ...
          <div className="show-event">
            <FormControl component="fieldset">
              <FormLabel component="div" className="title">
                Event
              </FormLabel>
            ...
            {events.map((element, index) => (
              <div className="event" key={index}>
                <FormControlLabel
                  ...
                  control={
                    <Checkbox
                      checked={filter.types.includes(element)}
