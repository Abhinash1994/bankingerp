...
class FusePageSimple extends React.Component {
  ...
  render() {
    ...
    const headerContent = (
      <div className={classNames(classes.header, "page-header")}>
        {header && (
          <MuiThemeProvider theme={mainThemeDark}>{header}</MuiThemeProvider>
        )}
      </div>
    );
    ...
    return (
      ...
      >
        ...
        <div className="flex flex-auto flex-col z-10">
...
export default withStyles(styles, { withTheme: true })(
  connect(mapStateToProps)(FusePageSimple)
);
